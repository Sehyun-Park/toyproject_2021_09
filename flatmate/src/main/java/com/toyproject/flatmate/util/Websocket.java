package com.toyproject.flatmate.util;
...
public class Websocket {
	...
	// 웹소켓 사용자 연결이 성립하는 경우 호출
	
	@OnOpen
	public void handlerOpen (Session session) {
	...
	public String handleMessage(String message, Session session) {
		...
		if(session != null) {
			...
			System.out.println("message is arrived. sessionId == [ " + sessionId + "]"
					+ "/ message == [ "  + message + "]");
	...
	public void handleClose(Session session) {
		if(session != null) {
			...
			System.out.println("client is disconnect. sessionId == [" + sessionId + "]");
